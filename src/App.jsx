...
export default function App() {
  ...
  return (
    <div className="flex h-screen">
      {/* Sidebar */}
      <div
        className={`fixed top-0 left-0 h-screen bg-gray-800 text-white w-[75%] sm:w-[60%] md:w-[20%] z-30 transition-transform duration-300 ${
      ...
      <div className="flex-1 flex flex-col md:ml-[20%]">
        ...
        <div className="mt-16  md:p-6 overflow-auto  h-full">
          <div className="w-full md:w-[85%] mx-auto p-2 ">
            <Aboutme />
            <Skills />
            <Education />
            <Experience />
